...
/** The 44 volumes of the series (ass volumes spec §1), less the five this phase sampled. */
const volumesLeft = 44 - sources.length;
...
p(`   over the series' 44 volumes; the consistorial allocutions of Pius IX and Leo XIII are a shelf of their own, and whether the`);
