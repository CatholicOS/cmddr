...
them and 24 were read by hand, 97 in all, and **64** references follow (Leo XIII 35, Pius X 29, Pius IX none: ASS 1's three acts are hand
...
on their date), 61 of them by the unique rule and 3 by the opening rule — the shelf's incipit as a word-boundary prefix of the
